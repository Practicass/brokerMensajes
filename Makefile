...
MOM:
	@echo "Ejecutando programa 1 en una nueva terminal..."
	cd $(PROGRAM1_DIR) && go run MOM.go 127.0.0.1:8084


# Objetivo para ejecutar el segundo programa en una nueva terminal
consumidor1:
	@echo "Ejecutando consumidores en una nueva terminal..."
	cd $(PROGRAM2_DIR) && go run consumidor.go Juan 127.0.0.1:8084 127.0.0.1:8081

consumidor2:
	@echo "Ejecutando consumidores en una nueva terminal..."
	cd $(PROGRAM2_DIR) && go run consumidor.go Maria 127.0.0.1:8084 127.0.0.1:8082


# Objetivo para ejecutar el tercer programa en una nueva terminal
productor:
	@echo "Ejecutando productor en una nueva terminal..."
	cd $(PROGRAM3_DIR) && go run productor.go Pedro 127.0.0.1:8084